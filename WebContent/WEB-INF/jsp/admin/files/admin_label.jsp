...
/* 		if (value == 0) {
	...
	function searchFiles() {
		//alert('onclicked');
		tab.datagrid("load", {
			"type" : '0',//$('#typeName').combobox('getValue'),
			"name" : $("#name").val()
		});
	};
	...
	<div region="north" border="false" split="true" title="查询条件" iconCls="icon-search" style="height: 90px;padding-top: 10px;">
		...
		<form action="" id="queryForm">
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				...
				<tr>
                    <td>
                    	分组标签： <input name="name" id="name" style="width: 150px;"/>
                    </td>
                    <td>
						<input id="queryBton" type="button" class="btn122" value="查询" onclick="searchFiles();"/>
                    </td>
                </tr>
            </table>
        </form>
