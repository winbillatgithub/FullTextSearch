...
(function($) {
	$.parser = {
		...
		plugins : [ "draggable", "droppable", "resizable", "pagination",
				...
				"timespinner", "calendar", "datebox", "dateboxclean",
				"datetimebox", "datetimeboxclean", "slider", "layout", "panel",
...
(function($) {
	function _6d(_6e) {
		...
		if (_6f.text) {
			...
			// t.find(".l-btn-text").html("<span
			// class=\"l-btn-empty\">&nbsp;</span>");
			// if(_6f.iconCls){
			// t.find(".l-btn-empty").addClass(_6f.iconCls);
			// }
			if (_6f.iconCls) {
				if (_6f.iconCls == "pagination-first") {
					t.find(".l-btn-text").html("首页");
				} else if (_6f.iconCls == "pagination-prev") {
					t.find(".l-btn-text").html("上一页");
				} else if (_6f.iconCls == "pagination-next") {
					t.find(".l-btn-text").html("下一页");
				} else if (_6f.iconCls == "pagination-last") {
					t.find(".l-btn-text").html("末页");
				} else {
					t.find(".l-btn-text").html("刷新");
				}
			}
		}
	...
	function load(_3f7, data) {
		...
		function _3fb(name, val) {
			...
			var cc = [ "combobox", "combotree", "combogrid", "datetimebox",
					"datetimeboxclean", "datebox", "dateboxclean", "combo" ];
...
(function($) {
	...
	var _5be = {
		...
		dateboxclean : {
			init : function(_a5e8, _a5e9) {
				var _a5ea = $("<input type=\"text\">").appendTo(_a5e8);
				_a5ea.dateboxclean(_a5e9);
				return _a5ea;
			},
			destroy : function(_a5eb) {
				$(_a5eb).dateboxclean("destroy");
			},
			getValue : function(_a5ec) {
				return $(_a5ec).dateboxclean("getValue");
			},
			setValue : function(_a5ed, _a5ee) {
				$(_a5ed).dateboxclean("setValue", _a5ee);
			},
			resize : function(_a5ef, _a5f0) {
				$(_a5ef).dateboxclean("resize", _a5f0);
			}
		},
		combobox : {
...
(function($) {
	...
	function _7f2(_7f3, data, _7f4) {
		...
		var item0 = $("<div class=\"combobox-item\"></div>").appendTo(_7f5);
		item0.attr("value", '');
		item0.html("&nbsp;");
...
(function($) {
	function _a852(_a853) {
		var _a854 = $.data(_a853, "dateboxclean");
		var opts = _a854.options;
		$(_a853).addClass("datebox-f");
		$(_a853).combo($.extend({}, opts, {
			onShowPanel : function() {
				_a854.calendar.calendar("resize");
				opts.onShowPanel.call(_a853);
			}
		}));
		$(_a853).combo("textbox").parent().addClass("datebox");
		if (!_a854.calendar) {
			_a855();
		}
		function _a855() {
			var _a856 = $(_a853).combo("panel");
			_a854.calendar = $("<div></div>").appendTo(_a856).wrap(
					"<div class=\"datebox-calendar-inner\"></div>");
			_a854.calendar.calendar({
				fit : true,
				border : false,
				onSelect : function(date) {
					var _a857 = opts.formatter(date);
					_a85b(_a853, _a857);
					$(_a853).combo("hidePanel");
					opts.onSelect.call(_a853, date);
				}
			});
			_a85b(_a853, opts.value);
			var _a858 = $("<div class=\"datebox-button\"></div>").appendTo(
					_a856);
			$("<a href=\"javascript:void(0)\" class=\"datebox-current\"></a>")
					.html(opts.currentText).appendTo(_a858);
			$("<a href=\"javascript:void(0)\" class=\"datebox-clean\"></a>")
					.html(opts.cleanText).appendTo(_a858);
			$("<a href=\"javascript:void(0)\" class=\"datebox-close\"></a>")
					.html(opts.closeText).appendTo(_a858);
			_a858.find(".datebox-current,.datebox-close,.datebox-clean").hover(
					function() {
						$(this).addClass("datebox-button-hover");
					}, function() {
						$(this).removeClass("datebox-button-hover");
					});
			_a858.find(".datebox-current").click(function() {
				_a854.calendar.calendar({
					year : new Date().getFullYear(),
					month : new Date().getMonth() + 1,
					current : new Date()
			...
			_a858.find(".datebox-clean").click(function() {
				$(_a853).combo("setValue", "").combo("setText", "");
				$(_a853).val("");
				$(_a853).combo("hidePanel");
			});
			_a858.find(".datebox-close").click(function() {
				$(_a853).combo("hidePanel");
			});
		}
		;
	...
	;
	function _a859(_a85a, q) {
		_a85b(_a85a, q);
	}
	;
	function _a85c(_a85d) {
		var opts = $.data(_a85d, "dateboxclean").options;
		var c = $.data(_a85d, "dateboxclean").calendar;
		var _a85e = opts.formatter(c.calendar("options").current);
		_a85b(_a85d, _a85e);
		$(_a85d).combo("hidePanel");
	}
	;
	function _a85b(_a85f, _a860) {
		var _a861 = $.data(_a85f, "dateboxclean");
		var opts = _a861.options;
		$(_a85f).combo("setValue", _a860).combo("setText", _a860);
		_a861.calendar.calendar("moveTo", opts.parser(_a860));
	}
	;
	$.fn.dateboxclean = function(_a862, _a863) {
		if (typeof _a862 == "string") {
			var _a864 = $.fn.dateboxclean.methods[_a862];
			if (_a864) {
				return _a864(this, _a863);
			} else {
				return this.combo(_a862, _a863);
			}
		}
		_a862 = _a862 || {};
		return this.each(function() {
			var _a865 = $.data(this, "dateboxclean");
			if (_a865) {
				$.extend(_a865.options, _a862);
			} else {
				$.data(this, "dateboxclean", {
					options : $.extend({}, $.fn.dateboxclean.defaults,
							$.fn.dateboxclean.parseOptions(this), _a862)
				});
			}
			_a852(this);
		});
	};
	$.fn.dateboxclean.methods = {
		options : function(jq) {
			var _a866 = jq.combo("options");
			return $.extend($.data(jq[0], "dateboxclean").options, {
				originalValue : _a866.originalValue,
				disabled : _a866.disabled,
				readonly : _a866.readonly
			});
		},
		calendar : function(jq) {
			return $.data(jq[0], "dateboxclean").calendar;
		},
		setValue : function(jq, _a867) {
			return jq.each(function() {
				_a85b(this, _a867);
			});
		},
		reset : function(jq) {
			return jq.each(function() {
				var opts = $(this).dateboxclean("options");
				$(this).dateboxclean("setValue", opts.originalValue);
			});
		}
	};
	$.fn.dateboxclean.parseOptions = function(_a868) {
		var t = $(_a868);
		return $.extend({}, $.fn.combo.parseOptions(_a868), {});
	};
	$.fn.dateboxclean.defaults = $.extend({}, $.fn.combo.defaults, {
		panelWidth : 180,
		panelHeight : "auto",
		keyHandler : {
			up : function() {
...
(function($) {
	function _a869(_a86a) {
		var _a86b = $.data(_a86a, "datetimeboxclean");
		var opts = _a86b.options;
		$(_a86a).dateboxclean($.extend({}, opts, {
			onShowPanel : function() {
				var _a86c = $(_a86a).datetimeboxclean("getValue");
				_a86f(_a86a, _a86c, true);
				opts.onShowPanel.call(_a86a);
			},
			formatter : $.fn.dateboxclean.defaults.formatter,
			parser : $.fn.dateboxclean.defaults.parser
		}));
		$(_a86a).removeClass("datebox-f").addClass("datetimebox-f");
		$(_a86a).dateboxclean("calendar").calendar({
			onSelect : function(date) {
				opts.onSelect.call(_a86a, date);
			}
		});
		var _a86d = $(_a86a).dateboxclean("panel");
		if (!_a86b.spinner) {
			var p = $(
					"<div style=\"padding:2px\"><input style=\"width:80px\"></div>")
					.insertAfter(_a86d.children("div.datebox-calendar-inner"));
			_a86b.spinner = p.children("input");
			var _a86e = _a86d.children("div.datebox-button");
			var blockText = $(
			"<span></span>")
			.html(opts.blockText).appendTo(_a86e);
			var ok = $(
					"<a href=\"javascript:void(0)\" class=\"datebox-ok\"></a>")
					.html(opts.okText).appendTo(_a86e);
			ok.hover(function() {
				$(this).addClass("datebox-button-hover");
			}, function() {
				$(this).removeClass("datebox-button-hover");
		...
		_a86b.spinner.timespinner({
			showSeconds : opts.showSeconds,
			separator : opts.timeSeparator
		}).unbind(".datetimeboxclean").bind("mousedown.datetimeboxclean",
				function(e) {
					e.stopPropagation();
				});
		_a86f(_a86a, opts.value);
	}
	;
	function _a870(_a871) {
		var c = $(_a871).datetimeboxclean("calendar");
		var t = $(_a871).datetimeboxclean("spinner");
		var date = c.calendar("options").current;
		return new Date(date.getFullYear(), date.getMonth(), date.getDate(), t
				.timespinner("getHours"), t.timespinner("getMinutes"), t
				.timespinner("getSeconds"));
	...
	;
	function _a872(_a873, q) {
		_a86f(_a873, q, true);
	}
	;
	function _a874(_a875) {
		var opts = $.data(_a875, "datetimeboxclean").options;
		var date = _a870(_a875);
		_a86f(_a875, opts.formatter.call(_a875, date));
		$(_a875).combo("hidePanel");
	}
	;
	function _a86f(_a876, _a877, _a878) {
		var opts = $.data(_a876, "datetimeboxclean").options;
		$(_a876).combo("setValue", _a877);
		if (!_a878) {
			if (_a877) {
				var date = opts.parser.call(_a876, _a877);
				$(_a876).combo("setValue", opts.formatter.call(_a876, date));
				$(_a876).combo("setText", opts.formatter.call(_a876, date));
			} else {
				$(_a876).combo("setText", _a877);
			}
		}
		var date = opts.parser.call(_a876, _a877);
		$(_a876).datetimeboxclean("calendar").calendar("moveTo", date);
		$(_a876).datetimeboxclean("spinner").timespinner("setValue",
				_a879(date));
		function _a879(date) {
			function _a87a(_a87b) {
				return (_a87b < 10 ? "0" : "") + _a87b;
			}
			;
			var tt = [ _a87a(date.getHours()), _a87a(date.getMinutes()) ];
			if (opts.showSeconds) {
				tt.push(_a87a(date.getSeconds()));
			}
			return tt.join($(_a876).datetimeboxclean("spinner").timespinner(
					"options").separator);
		}
		;
	}
	;
	$.fn.datetimeboxclean = function(_a87c, _a87d) {
		if (typeof _a87c == "string") {
			var _a87e = $.fn.datetimeboxclean.methods[_a87c];
			if (_a87e) {
				return _a87e(this, _a87d);
			} else {
				return this.dateboxclean(_a87c, _a87d);
			}
		}
		_a87c = _a87c || {};
		return this.each(function() {
			var _a87f = $.data(this, "datetimeboxclean");
			if (_a87f) {
				$.extend(_a87f.options, _a87c);
			} else {
				$.data(this, "datetimeboxclean", {
					options : $.extend({}, $.fn.datetimeboxclean.defaults,
							$.fn.datetimeboxclean.parseOptions(this), _a87c)
				});
			}
			_a869(this);
		});
	};
	$.fn.datetimeboxclean.methods = {
		options : function(jq) {
			var _a880 = jq.dateboxclean("options");
			return $.extend($.data(jq[0], "datetimeboxclean").options, {
				originalValue : _a880.originalValue,
				disabled : _a880.disabled,
				readonly : _a880.readonly
			});
		},
		spinner : function(jq) {
			return $.data(jq[0], "datetimeboxclean").spinner;
		},
		setValue : function(jq, _a881) {
			return jq.each(function() {
				_a86f(this, _a881);
			});
		},
		reset : function(jq) {
			return jq.each(function() {
				var opts = $(this).datetimeboxclean("options");
				$(this).datetimeboxclean("setValue", opts.originalValue);
			});
		}
	};
	$.fn.datetimeboxclean.parseOptions = function(_a882) {
		var t = $(_a882);
		return $.extend({}, $.fn.dateboxclean.parseOptions(_a882), $.parser
				.parseOptions(_a882, [ "timeSeparator", {
					showSeconds : "boolean"
				} ]));
	};
	$.fn.datetimeboxclean.defaults = $.extend({}, $.fn.dateboxclean.defaults, {
		showSeconds : true,
		timeSeparator : ":",
		keyHandler : {
			up : function() {
		...
		formatter : function(date) {
			...
			var M = date.getMinutes();
			var s = date.getSeconds();
			function _a883(_a884) {
				return (_a884 < 10 ? "0" : "") + _a884;
			}
			;
			var _a885 = $(this).datetimeboxclean("spinner").timespinner(
					"options").separator;
			var r = $.fn.dateboxclean.defaults.formatter(date) + " " + _a883(h)
					+ _a885 + _a883(M);
			if ($(this).datetimeboxclean("options").showSeconds) {
				r += _a885 + _a883(s);
			}
			return r;
		},
		parser : function(s) {
			...
			var dt = s.split(" ");
			var d = $.fn.dateboxclean.defaults.parser(dt[0]);
			if (dt.length < 2) {
				return d;
			}
			var _a886 = $(this).datetimeboxclean("spinner").timespinner(
					"options").separator;
			var tt = dt[1].split(_a886);
			var hour = parseInt(tt[0], 10) || 0;
			var _a887 = parseInt(tt[1], 10) || 0;
			var _a888 = parseInt(tt[2], 10) || 0;
