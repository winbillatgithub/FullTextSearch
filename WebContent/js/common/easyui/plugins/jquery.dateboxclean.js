...
function _d(_e){
var _f=$.data(_e,"dateboxclean").options;
var c=$.data(_e,"dateboxclean").calendar;
var _10=_f.formatter(c.calendar("options").current);
_c(_e,_10);
$(_e).combo("hidePanel");
};
function _c(_11,_12){
var _13=$.data(_11,"dateboxclean");
var _14=_13.options;
...
var _18=$.data(this,"dateboxclean");
if(_18){
$.extend(_18.options,_15);
}else{
$.data(this,"dateboxclean",{options:$.extend({},$.fn.datebox.defaults,$.fn.datebox.parseOptions(this),_15)});
}
_1(this);
});
};
...
return $.extend($.data(jq[0],"dateboxclean").options,{originalValue:_19.originalValue,disabled:_19.disabled,readonly:_19.readonly});
},calendar:function(jq){
return $.data(jq[0],"dateboxclean").calendar;
