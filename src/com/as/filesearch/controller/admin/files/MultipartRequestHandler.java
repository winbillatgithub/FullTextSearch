...
public class MultipartRequestHandler {
	...
	MultipartRequestHandler(String path, IUploadedFileInfoEntityService uploadedFileInfoEntityService) {
		this.uploadFilePath = path;
		this.uploadedFileInfoEntityService = uploadedFileInfoEntityService;
	}
			...
			while (it.hasNext()) {
				...
				if (obit instanceof DiskFileItem) {
					...
					if (fileName != null) {
						...
						int count = uploadedFileInfoEntityService.selectAllCount(paramMap);
